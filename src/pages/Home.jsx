  ...
  const slides = [
    {
      title: "Slide 1",
      imageUrl:
        "https://rusanov-d.ru/api/uploads/RobloxScreenShot20230605_131002741.png",
    },
    {
      title: "Slide 2",
      imageUrl:
        "https://rusanov-d.ru/api/uploads/RobloxScreenShot20230605_131058204.png",
    },
    {
      title: "Slide 3",
      imageUrl:
        "https://rusanov-d.ru/api/uploads/RobloxScreenShot20230605_131031179.png",
    },
  ];
            ...
            posts.slice(0, 4).map((post, index) => (
              ...
              >
                <Post
                  ...
                  title={post.title}
                  imageUrl={
                    post.imageUrl ? `https://rusanov-d.ru/api${post.imageUrl}` : ""
                  }
                  user={post.user}
            ...
            services.slice(0, 4).map((service) => (
              ...
              >
                <Service
                  ...
                  title={service.title}
                  imageUrl={
                    service.imageUrl ? `https://rusanov-d.ru/api${service.imageUrl}` : ""
                  }
                  user={service.user}
